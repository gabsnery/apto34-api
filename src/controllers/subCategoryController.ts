...
async function getSubcategorias(req: Request, res: Response, next: NextFunction) {
...
async function transformValue(subcategories: any[]): Promise<ProdutoSubcategoriaResponse[]> {
